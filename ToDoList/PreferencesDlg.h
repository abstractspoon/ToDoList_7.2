...
public:
	...
	int GetInheritParentAttributes(CTDCAttributeMap& mapAttribs) const { return m_pageTaskDef2.GetInheritParentAttributes(mapAttribs); }
	BOOL GetContinueToUpdateSubtasks() const { return m_pageTaskDef2.GetContinueToUpdateSubtasks(); }
